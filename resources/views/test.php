...
<!-- Mirrored from demos.pixelatethemes.com/eaglet-new/table-row-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Feb 2018 10:55:28 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="css/lib/datatable/dataTables.bootstrap.min.html" rel="stylesheet" />
    <link href="css/lib/datatable/buttons.bootstrap.min.html" rel="stylesheet" />
...
<body>
        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <div class="logo"><a href="index-2.html"><!-- <img src="images/logo.png" alt="" /> --><span>Eaglet</span></a></div>
                    <ul>
                        ...
                        <li class="active"><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                ...
                                <li><a href="index7.html">Dashboard 7</a></li>
                                <li><a href="index8.html">Dashboard 8</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="sidebar-sub-toggle"><i class="ti-email"></i> Email <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                        ...
                        <li><a class="sidebar-sub-toggle"><i class="ti-map"></i> Forms <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                        ...
                        <li><a href="http://demos.pixelatethemes.com/documentation/index.html"><i class="ti-file"></i> Documentation</a></li>
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-default">
                                    ...
                                    <span class="input-group-btn"><button type="submit" class="btn btn-primary"><i class="ti-search"></i></button></span>
                                </div>
                            </div>
                            </div>
                        </form>
    ...
    <script src="js/lib/data-table/dataTables.bootstrap.min.html"></script>
    <script src="js/lib/data-table/dataTables.buttons.min.js"></script>
    <script src="js/lib/data-table/buttons.bootstrap.min.html"></script>
...
<!-- Mirrored from demos.pixelatethemes.com/eaglet-new/table-row-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Feb 2018 10:55:30 GMT -->
</html>